...
src/{{ cookiecutter.project_slug }}/
    {{ cookiecutter.project_slug }}.py    # Core algorithm ({{ cookiecutter.class_name }} class)
...
### CLI Module: src/{{ cookiecutter.project_slug }}/cli.py
...
The `{{ cookiecutter.class_name }}` class can be used in other Python applications:

```python
from {{ cookiecutter.project_slug }}.{{ cookiecutter.command_name }} import {{ cookiecutter.class_name }}
import sys
