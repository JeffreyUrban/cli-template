...
This document describes the enhanced oracle-based testing framework for {{ cookiecutter.project_slug }}. The oracle provides ground truth for validating the correctness of the optimized implementation.
