...
pytest --cov=src/{{ cookiecutter.project_slug }} --cov-fail-under=80

# View HTML report
open htmlcov/index.html

# Generate XML for CI
pytest --cov=src/{{ cookiecutter.project_slug }} --cov-report=xml
```
...
- Use proper imports: `from {{ cookiecutter.project_slug }} import module`
