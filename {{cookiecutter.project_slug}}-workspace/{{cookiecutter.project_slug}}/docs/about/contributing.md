...
**Environment**:
- {{ cookiecutter.command_name }} version: `{{ cookiecutter.command_name }} --version`
...
├── src/{{ cookiecutter.command_name }}/          # Source code
│   ├── __init__.py
...
```bash
# Time a command
time {{ cookiecutter.command_name }} large-file.log > /dev/null

# Profile with cProfile
python -m cProfile -s cumulative -m {{ cookiecutter.command_name }} large-file.log
```
...
1. **Add to CLI** (`src/{{ cookiecutter.command_name }}/cli.py`):
   ```python
   @app.command()
   def main(
       # ... existing options ...
...
3. **Add tests**:
   ```python
   def test_my_option():
       dedup = {{ cookiecutter.class_name }}(my_option=50)
       # Test behavior
   ```
...
- **Documentation**: https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.command_name }}/docs
- **Issue Tracker**: https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.command_name }}/issues
- **Discussions**: https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.command_name }}/discussions
...
By contributing to {{ cookiecutter.command_name }}, you agree that your contributions will be licensed under the MIT License.
...
Thank you for contributing to {{ cookiecutter.command_name }}! 🎉
